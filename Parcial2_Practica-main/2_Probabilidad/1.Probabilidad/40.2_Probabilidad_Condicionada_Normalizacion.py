class PrediccionElecciones:
    def __init__(self, probabilidad_previa_victoria, probabilidad_apoyo_encuestas, probabilidad_participacion_votantes):
        self.probabilidad_previa_victoria = probabilidad_previa_victoria  # Probabilidad a priori de que el candidato gane
    ...
    def probabilidad_condicional(self, apoyo_encuestas, participacion_votantes):
        ...
        probabilidad_conjunta_victoria = (self.probabilidad_previa_victoria *
                                          self.probabilidad_apoyo_encuestas[apoyo_encuestas] *
                                          self.probabilidad_participacion_votantes[participacion_votantes])

        probabilidad_conjunta_derrota = ((1 - self.probabilidad_previa_victoria) *
        ...
        probabilidad_condicional_victoria = probabilidad_conjunta_victoria / probabilidad_total if probabilidad_total != 0 else 0
        return probabilidad_condicional_victoria

# Probabilidades a priori y condicionales
probabilidad_previa_victoria_inicial = 0.5  # Probabilidad a priori de que el candidato gane
...
modelo_prediccion = PrediccionElecciones(probabilidad_previa_victoria_inicial, probabilidad_apoyo_encuestas_diccionario, probabilidad_participacion_votantes_diccionario)
